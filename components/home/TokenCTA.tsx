    ...
    <section className="mx-auto max-w-7xl px-4 py-16">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="overflow-hidden rounded-2xl border border-backlot-gold/20 bg-gradient-to-br from-backlot-surface to-backlot-bg p-8 text-center md:p-12">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <a href="https://pump.fun/coin/DSL6XbjPfhXjD9YYhzxo5Dv2VRt7VSeXRkTefEu5pump" target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-lg bg-backlot-gold px-8 py-3 font-medium text-backlot-bg transition hover:bg-backlot-gold/90">Buy on Pump.fun</a>
        </div>
